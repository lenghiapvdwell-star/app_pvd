...
# 2. Xây dựng mã khóa PEM thủ công (Dứt điểm lỗi InvalidByte)
# Chúng ta chia nhỏ để Python không bị nhầm lẫn ký tự
key_lines = [
...
# Tạo lại cấu trúc PEM chuẩn
PRIVATE_KEY = "-----BEGIN PRIVATE KEY-----\n" + "\n".join(key_lines) + "\n-----END PRIVATE KEY-----\n"

# Thông tin tài khoản (Dán trực tiếp)
creds_dict = {
