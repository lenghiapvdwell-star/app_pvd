...
def calculate_pvd_logic(df):
    ...
    # Tổng ca = Tồn cũ + Phát sinh tháng này
...
with t1:
    ...
    # --- CÔNG CỤ CẬP NHẬT NHANH (MỚI KHÔI PHỤC) ---
    ...
    config = {
        ...
        "CA Tháng Trước": st.column_config.NumberColumn("Tồn Cũ", format="%.1f", help="Tồn cuối tháng trước chuyển sang"),
        "Quỹ CA Tổng": st.column_config.NumberColumn("Tổng ca", format="%.1f", disabled=True, help="Tồn Cũ + Phát sinh tháng này"),
    }
